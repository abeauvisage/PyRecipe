...
source.include_patterns = %(source.dir)s/recipes/*.yaml,%(source.dir)s/src/*.py,%(source.dir)s/kv/*.kv,%(source.dir)s/rsrc/icons/*.png
...
presplash.filename = %(source.dir)s/rsrc/icons/logo600_center.png

# (str) Icon of the application
icon.filename = %(source.dir)s/rsrc/icons/logo150.png
